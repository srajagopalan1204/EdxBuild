...
# Version: 20251205_0930  (America/New_York)
...
def main(argv):
    ...
    ap.add_argument("--sop", required=True, help="SOP code (e.g., LineEnt)")
    ...
    sequence_order = [e["base"] for e in entries]
    extraction = {
    ...
    header_lines = [
        ...
        f"// Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} (America/New_York)",
        "// Authors: Subi Rajagopalan   with assistance from ChatGPT (OpenAI)",
    ]
    header_txt = "\n".join(header_lines)
